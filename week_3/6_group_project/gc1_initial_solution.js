...
var median = function(arr) {
	...
	// if the array length is odd, then return the integer in the middle of the array.  In other words, return array at index half.
	if(arr.length % 2 == 1) {
		return arr[half];
	}
	// if the array lenght is even, then return the sum of the two middle integers divided my two.  In other words, return array at index half plus array at index half - 1, then divide that by 2
	else {
